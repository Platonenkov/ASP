...
namespace WebStore.Data
{
    public static class TestData
    {
        public static List<Section> Sections { get; } = new List<Section>
        {
            ...
            new Section {Id=30, Name="Дольче-Габана", Order=7, ParentId=7},
            new Section {Id=31, Name="Шанель", Order=8, ParentId=7},
            new Section {Id=32, Name="Гуччи", Order=9, ParentId=7},
            new Section {Id=15, Name="Женские", Order=2},
            new Section {Id=16, Name="Fendi", Order=0,ParentId=15},
            new Section {Id=17, Name="Guess", Order=1,ParentId=15},
            new Section {Id=18, Name="Valentino", Order=2, ParentId=15},
            new Section {Id=19, Name="Dior", Order=3, ParentId=15},
            new Section {Id=20, Name="Версаче", Order=4, ParentId=15},
            new Section {Id=21, Name="Армани", Order=5,  ParentId=15},
            new Section {Id=22, Name="Прада", Order=6, ParentId=15},
            new Section {Id=23, Name="Детские", Order=2},
            new Section {Id=24, Name="Мода", Order=2},
            new Section {Id=25, Name="Для Дома", Order=3},
            new Section {Id=26, Name="Интерьер", Order=4},
            new Section {Id=27, Name="Одежда", Order=5},
            new Section {Id=28, Name="Сумки", Order=6},
            new Section {Id=29, Name="Обувь", Order=7},
        };
